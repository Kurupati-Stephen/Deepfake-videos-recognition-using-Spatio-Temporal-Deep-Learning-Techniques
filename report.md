...
4. **Explainability Dashboard Module**: The system generates a final video prediction via the hidden states of the LSTM and concurrently pushes individual spatial embeddings to a dense layer for frame-wise analysis. A Streamlit frontend renders the video, result, confidence score, and top suspicious frames with warning highlights.
